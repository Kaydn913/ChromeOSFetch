...
printf "${RED}  ,oooooooooooooooooooo${Y}ooooo,   ${B}Host${R}: %s\n" "$hwid"
printf "${RED} ;ooooooooooooooo${W}oo${Y}oooooooo;  ${G}Kernel${R}: %s\n" "$kernel"
printf "${RED}:ooooooooooo${W}oooooooo${Y}oooooooo: ${G}Uptime${R}: %s\n" "$uptime"
printf "${G}ooooooo${RED}ooo${W}oo${B}########${W}oo${Y}oooooo ${Y}Shell${R}: %s\n" "$shell_name"
printf "${G}ooooooooo${W}o${B}##########${W}o${Y}oooooo ${Y}CPU${R}: %s\n" "$cpu"
printf "${G}ooooooooo${W}o${B}##########${W}o${Y}oooooo ${C}GPU${R}: %s\n" "$gpu"
printf "${G}:oooooooooo${W}oo${B}########${W}oo${Y}ooooo: ${C}Memory${R}: %s\n" "$memory"
printf "${G} ;oooooooooooo${W}oooooooo${Y}oooo;  ${B}Display${R}: %s\n" "$displays"
printf "${G}  ,oooooooooooooooooo${Y}oooooo,   ${B}Battery${R}: %s\n" "$battery"
printf "${G}    ,ooooooooooooooooooooo,     ${G}Disk${R}: %s\n" "$disk"
